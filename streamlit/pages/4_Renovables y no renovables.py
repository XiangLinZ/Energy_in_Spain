...
st.write("<h1 style='text-align: center;'>Porcentaje de Renovables</h1>", unsafe_allow_html=True)
"---"
...
st.write("<h5 style='text-align: center;'>Porcentaje de energía Renovables y no Renovable en los últimos años</h5>", unsafe_allow_html=True)
col1, col2 = st.columns(2)
with col1:
    st.write(f"<h6 style='text-align: center;'>Renovable</h6>", unsafe_allow_html=True)
    st.write(f"<h2 style='text-align: center;'>{round(mean_value_reno,2)}%</h2>", unsafe_allow_html=True)
with col2:
    st.write(f"<h6 style='text-align: center;'>No Renovable</h6>", unsafe_allow_html=True)
